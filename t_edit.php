...
<div id="edit">
    ...
    <form action="" method="post">
        <ul>
           <br>
                <label for="tenant_id" hidden>Tenant Id  </label>
                <input type="text" name="tenant_id" id="tenant_id" required value="<?= $tenant["tenant_id"]; ?>" style="margin-left: 160px;" hidden>
          ...
          <br><br>
          <label for="id_card" hidden> Status</label>
                <input type="text" name="status" id="status"required value="<?= $tenant["status"]; ?>" style="margin-left: 184px;" hidden>
